...
| TC 그룹 | 실행 | 근거 |
| --- | :---: | --- |
| 단위 U-A-01~11 | ✅ 전체 | SQLite·네트워크 불필요 · 항상 실행 |
| 단위 U-B-01~10 | ✅ 전체 | 테트리스 엔진(심화 트랙 수행 시) |
| 통합 I-A-01~09 (읽기·쓰기) | ✅ 전체 | `ALLOW_WRITE=true` — GitHub 실제 호출·SQLite 쓰기·**실제 Notion 업로드** 포함 |
| 통합 I-A-10·11 (읽기 전용) | ✅ 전체 | 안전 |
| E2E E-A-01~07 | ✅ 전체 | 쓰기 포함 — Notion 업로드는 `.env` 설정에 따라 E-A-06(미설정) 또는 E-A-07(설정됨) 로 분기 |
